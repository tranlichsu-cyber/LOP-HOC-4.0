...
import { Gamepad2, Swords, Joystick, Play, Loader2, X, Trophy } from 'lucide-react';
...
export default function StudentGames({ offlineGames }: { offlineGames: Game[] }) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 h-full w-full pb-6 font-kids">
      <div className="w-full lg:w-1/3 bg-kids-fun rounded-[3rem] p-8 sm:p-12 flex flex-col items-center justify-center text-center relative overflow-hidden shadow-xl shrink-0 border-4 border-white">
